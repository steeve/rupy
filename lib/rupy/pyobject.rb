  ...
  class PyObject
    ...
    class AutoPyPointer < FFI::AutoPointer
      class << self
        ...
        # running Python interpreter, so that Rupy knows not to try to
    ...
    # not the same as {#callable?} as many other Python objects are
    # callable.
    ...
    # Returns the 'directory' of the Python object; similar to #methods in
    # Ruby.
    def dir
    ...
    # Takes an array of wrapped Python objects and wraps them in a tuple
