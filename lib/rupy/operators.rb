module Rupy
  # A mixin module to provide method delegation to a proxy class. This is
  # done either by delegating to methods defined on the wrapped object or by
  # using the Python _operator_ module. A large number of the methods are
  # dynamically generated and so their documentation is not provided here.
  # In general all operators that can be overloaded are delegated.
  module Operators
    ...
    # mode of operation as set by {Rupy.legacy_mode}.
    # @param[Symbol, String] rname The name of the Ruby method for this
    #                              operation
    ...
    # delegated method will always be converted to a Ruby type so that
    # simple boolean testing may occur. These methods are implemented with
    # calls the _operator_ module.
    # @param[Symbol, String] rname The name of the Ruby method for this
    #                              operation
    # @param[String] pname The name of the Python magic method to which this
    #                      method should be delegated.
    ...
    # Creates a method to delegate a relational operator. The result of the
    # operation will follow the conversion rules appropriate to the current
    # mode of operation as set by {Rupy.legacy_mode}. These methods are
